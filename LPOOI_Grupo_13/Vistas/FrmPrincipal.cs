...
namespace Vistas
{
    public partial class FrmPrincipal : Form
    {
        ...
        {
            openChildFormInPanel(new FrmAbmProducto());
            hideSubMenu();
        }
        ...
        {
            openChildFormInPanel(new FrmAbmCliente());
        ...
        {
            openChildFormInPanel(new FrmAbmObraSocial());
        }

        private void btnUsuario_Click(object sender, EventArgs e)
        {
            openChildFormInPanel(new FrmAbmUsuario());
        }
        ...
        {
            DialogResult result = MessageBox.Show("¿Está seguro de que desea cerrar la sesión?", "Confirmar cierre de sesión", MessageBoxButtons.YesNo, MessageBoxIcon.Question);

            if (result == DialogResult.Yes)
            {
                // Mostrar el formulario de inicio de sesión (FrmLogin)
                FrmLogin frmLogin = new FrmLogin();
                frmLogin.Show();

                // Cerrar el formulario actual (FrmPrincipal)
                this.Hide();
            }
        }
    }
